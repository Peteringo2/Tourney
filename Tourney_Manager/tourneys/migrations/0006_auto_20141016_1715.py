...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tourneys', '0005_auto_20141016_1326'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Id_Winner', models.ForeignKey(default=None, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Id_tourney', models.ForeignKey(to='tourneys.Tourney', unique=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('Arrive_time', models.DateTimeField(verbose_name=b'Arrive Time')),
                ('Id_match', models.ForeignKey(to='tourneys.Match', unique=True)),
                ('Id_user', models.ForeignKey(to=settings.AUTH_USER_MODEL, unique=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='match',
            name='Id_round',
            field=models.ForeignKey(to='tourneys.Round', unique=True),
        ...
        migrations.AddField(
            model_name='code',
            name='Console',
            field=models.CharField(default=datetime.date(2014, 10, 16), max_length=75),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='tourney',
            name='Console',
            field=models.CharField(default='Console', max_length=75),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='tourney',
            name='End_date',
            field=models.DateTimeField(default=datetime.date(2014, 10, 16), verbose_name=b'End Date'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='tourney',
